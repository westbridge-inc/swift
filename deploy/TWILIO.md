...
and `OTP_GLOBAL_DAILY_CAP` (default 5000) bound OTP volume; they do not cap
every alert SMS. Set the global cap to an explicit affordable number for the
launch volume, then monitor provider usage.
