...
- [x] UXR-W-004 CLOSED (F-270): the palette question was ALREADY answered by the founder 07-16 (light, no second identity). Real residual = the code lying — dark.tsx exporting light tokens read as a broken dark theme to two consecutive reviews. Renamed surface.tsx, dk/D* = DASHBOARD, zero rendered-UI change, 409/409 green.
