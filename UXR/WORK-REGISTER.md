...
| UXR-W-007 | W1 | Web cart (S0) | WR-001 CONFIRMED: `setCartAddress(addrId).catch(()=>{})` swallows → checkout ships to stale/default. Fix: let it throw; outer catch renders | [~] | verified 08-23 |
