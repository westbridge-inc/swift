...
// Zero-commission model (master plan §18): there is intentionally no markup
// helper. Customer-facing prices equal the vendor's base price; this is
// asserted in the order/checkout suites, not here.
