  ...
  return (
    <SafeAreaView style={{ flex: 1 }} edges={['top']} className="bg-surface-base">
      ...
      <View className="flex-1 px-lg pt-sm">
        {list.map((a) => (
          <Pressable key={a.id} onPress={() => choose(a.latitude, a.longitude, a.label || a.addressLine1)}>
        ...
        <Pressable onPress={() => choose(GEORGETOWN.latitude, GEORGETOWN.longitude, GEORGETOWN.label)}>
          <Card className="mb-sm flex-row items-center">
