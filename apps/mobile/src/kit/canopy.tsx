 ...
 *
 * [DRIFT-09] Kit port of components/ui/canopy, verbatim mechanics.
 */
 ...
 * their own content inside; the 28pt radius is the masthead's shipped
 * geometry (structural, deliberate — see the legacy file's Metro-cache note).
 */
export function Canopy({ children, style }: { children: ReactNode; style?: ViewStyle }) {
  return (
    ...
    >
      <BrandGradient />
      <View style={{ paddingHorizontal: space.lg, paddingTop: space.md, paddingBottom: space.xl }}>{children}</View>
    </View>
  );
}
