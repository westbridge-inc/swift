 ...
 * springs back, driven by motion tokens. This is the single source of the
 * press-scale idiom that was previously copied inline (HomeScreen, VendorCard).
 * `strong` uses the larger dip — for big tappable tiles; default is for cards.
 */
